...
@NamedQueries({
            ...
            @NamedQuery(name = Meal.FIND, query = "SELECT m FROM Meal m WHERE m.user.id=:userId and m.id=:id")
        }
)
@Entity
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BY_USER = "Meal.getUserMeal";
    public static final String DELETE = "Meal.delete";
    public static final String FIND = "Meal.find";

    @Column(name = "date_time", nullable = false, unique = true, columnDefinition = "default timestamp now()")
    @NotNull
